...
func (rc *RoleController) AssignRoleToUser(w http.ResponseWriter, r *http.Request) {
	...
	utils.WriteJsonSucessResponse(w, http.StatusOK, "Role assigned to user successfully", nil)
...
func (rc *RoleController) GetAllRoles(w http.ResponseWriter, r *http.Request) {
	...
	utils.WriteJsonSucessResponse(w, http.StatusOK, "Roles fetched successfully", roles)
}
...
func (rc *RoleController) CreateRole(w http.ResponseWriter, r *http.Request) {
	...
	utils.WriteJsonSucessResponse(w, http.StatusCreated, "Role created successfully", role)
}
...
func (rc *RoleController) UpdateRole(w http.ResponseWriter, r *http.Request) {
	...
	utils.WriteJsonSucessResponse(w, http.StatusOK, "Role updated successfully", role)
}
...
func (rc *RoleController) DeleteRole(w http.ResponseWriter, r *http.Request) {
	...
	utils.WriteJsonSucessResponse(w, http.StatusOK, "Role deleted successfully", nil)
}
...
func (rc *RoleController) GetRolePermissions(w http.ResponseWriter, r *http.Request) {
	...
	utils.WriteJsonSucessResponse(w, http.StatusOK, "Role permissions fetched successfully", rolePermissions)
}
...
func (rc *RoleController) AssignPermissionToRole(w http.ResponseWriter, r *http.Request) {
	...
	utils.WriteJsonSucessResponse(w, http.StatusCreated, "Permission assigned to role successfully", rolePermission)
}
...
func (rc *RoleController) RemovePermissionFromRole(w http.ResponseWriter, r *http.Request) {
	...
	utils.WriteJsonSucessResponse(w, http.StatusOK, "Permission removed from role successfully", nil)
}
...
func (rc *RoleController) GetAllRolePermissions(w http.ResponseWriter, r *http.Request) {
	...
	utils.WriteJsonSucessResponse(w, http.StatusOK, "All role permissions fetched successfully", rolePermissions)
}
